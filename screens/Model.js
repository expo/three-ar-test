...
import { Light } from '../ar-utils';
import MagneticObject from '../ar-utils/MagneticObject';
import ShadowFloor from '../ar-utils/ShadowFloor';
...
export default class App extends React.Component {
  ...
  onContextCreate = async ({ gl, scale, width, height }) => {
    ...
    this.shadowFloor = new ShadowFloor({ width: 1, height: 1, opacity: 0.6 });
  ...
  loadModel = async () => {
    ...
    ThreeAR.scaleLongestSideToSize(mesh, 0.3);
